...
<html lang="en">
    ...
    <div id="layoutSidenav">
        ...
        <form action="/manager/products/{{$product->id}}/update" method="POST" enctype="multipart/form-data" id="formContainer">
        @csrf
        @method('PUT')
        ...
        <div class="mb-3">
            ...
            <input type="number" id="price" name="price" min="0" step="0.01" class="form-control" value="{{ $product->price }}" required>
        </div>

        <div class="mb-3">
            <label for="image" class="form-label">Product Image:</label>
            <input type="file" id="image" name="image" class="form-control">
            <!-- Note: The 'value' attribute is not applicable for file inputs -->
            <!-- Users will select a new file if they want to update the image -->
        </div>
